...
class Taxon(models.Model):
    ...
    rank_level = models.FloatField(null=True)  # 10=species, 20=genus, 30=family…
    ...
    # Slash-delimited ancestor iNat IDs for subtree queries
    ancestry = models.CharField(max_length=500, blank=True, default="")
    # iNat parent taxon ID (not a FK — avoids loading the full tree)
    parent_id = models.IntegerField(null=True, blank=True)
    # English preferred common name supplied by iNat
    ...
    def display_name(self):
        """Common name if available, otherwise scientific name."""
...
class TaxonName(models.Model):
    ...
    Lexicon values follow the iNaturalist convention:
      'English'          — English common name
      'Scientific Names' — accepted scientific name
      'Spanish'          — Spanish common name
      etc.
    """
    ...
    position = models.IntegerField(default=0)  # 0 = preferred for this lexicon
