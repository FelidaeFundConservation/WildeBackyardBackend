...
class FeatureCode(models.Model):
    ...
    name = models.CharField(max_length=200, null=True, blank=True, help_text="Short name of feature type")
    description = models.TextField(null=True, blank=True, help_text="Detailed description of feature type")
...
class GeoName(models.Model):
    ...
    name = models.CharField(max_length=200, null=True, blank=True, help_text="Name in UTF-8 format")
    asciiname = models.CharField(max_length=200, null=True, blank=True, help_text="Name in ASCII characters")
    alternatenames = models.CharField(
        max_length=10000, null=True, blank=True, help_text="Comma-separated alternate names"
    )
    latitude = models.DecimalField(
        max_digits=10, decimal_places=7, null=True, blank=True, help_text="Latitude in decimal degrees"
    )
    longitude = models.DecimalField(
        max_digits=10, decimal_places=7, null=True, blank=True, help_text="Longitude in decimal degrees"
    )
    fclass = models.CharField(
        max_length=1, null=True, blank=True, help_text="Feature class (A=admin, P=populated place, H=water, etc)"
    )
    fcode = models.CharField(max_length=10, null=True, blank=True, help_text="Feature code (detailed classification)")
    country = models.CharField(max_length=2, null=True, blank=True, help_text="ISO-3166 2-letter country code")
    cc2 = models.CharField(max_length=200, null=True, blank=True, help_text="Alternate country codes")
    admin1 = models.CharField(max_length=20, null=True, blank=True, help_text="State/province code (FIPS)")
    admin2 = models.CharField(max_length=80, null=True, blank=True, help_text="County/second-level admin code")
    admin3 = models.CharField(max_length=20, null=True, blank=True, help_text="Third-level admin code")
    admin4 = models.CharField(max_length=20, null=True, blank=True, help_text="Fourth-level admin code")
    ...
    timezone = models.CharField(max_length=40, null=True, blank=True, help_text="Timezone (e.g., America/Los_Angeles)")
    moddate = models.DateField(null=True, blank=True, help_text="Date of last modification")
    geom = models.PointField(srid=4326, null=True, blank=True, help_text="PostGIS Point geometry (WGS84)")
...
class PostalCode(models.Model):
    ...
    place_name = models.CharField(
        max_length=180, null=True, blank=True, help_text="Place name associated with postal code"
    )
    admin1_name = models.CharField(max_length=100, null=True, blank=True, help_text="State/province name")
    admin1_code = models.CharField(max_length=20, null=True, blank=True, help_text="State/province code")
    admin2_name = models.CharField(max_length=100, null=True, blank=True, help_text="County/district name")
    admin2_code = models.CharField(max_length=20, null=True, blank=True, help_text="County/district code")
    admin3_name = models.CharField(max_length=100, null=True, blank=True, help_text="Community name")
    admin3_code = models.CharField(max_length=20, null=True, blank=True, help_text="Community code")
    ...
    geom = models.PointField(srid=4326, null=True, blank=True, help_text="PostGIS Point geometry for centroid (WGS84)")
